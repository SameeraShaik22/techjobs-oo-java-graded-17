...
public class AbstractTest {
    ...
    protected String getJobString (Job job) throws NoSuchMethodException, ClassNotFoundException, InvocationTargetException, IllegalAccessException, NoSuchFieldException {
        return String.format(System.lineSeparator()+"ID: %d"+System.lineSeparator()+
                        ...
                        "Core Competency: %s"+System.lineSeparator(), getJobId(job), getJobFieldString(job, "name", true), getJobFieldString(job, "employer", true), getJobFieldString(job, "location", true),
